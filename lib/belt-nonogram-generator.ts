...
export const DEFAULT_PARAMS: GeneratorParams = {
  ...
  colAmbiguityMax: 300,
  colForcedMax: 5,
  minRounds: 4,  // higher = harder (started at 8)
  minLineUpdates: 18,   // higher = harder (started at 40)
  maxFirstRoundCellsSet: 60,   // lower = harder (started at 25)
  minMaxLineCandidatesSeen: 12,   // higher = harder (started at 40)
